  ...
  return (
    <>
      ...
      <header
        ...
        data-scrolled="false"
        className={
          // Cópia deste tema: "Conclave" — o header flutua a partir de lg (margem + rounded-panel
          // + borda nos 4 lados + shadow-header, que vira um glow arcano colorido no theme.css
          // deste tema, não uma linha). Abaixo de lg continua full-bleed com border-b — o mobile
          // precisa do espaço horizontal inteiro, flutuar ali só cortaria conteúdo útil.
          "group/header z-40 flex h-20 items-center justify-between gap-4 border-b border-header-border-subtle bg-card px-4 text-foreground shadow-header ui-motion-emphasis sm:px-6 lg:m-3 lg:h-24 lg:rounded-panel lg:border lg:border-header-border-subtle " +
          (stickyEnabled ? "sticky top-0 backdrop-blur-sm " : "") +
          (scrollShrinkEnabled
            ? "data-[scrolled=true]:h-16 data-[scrolled=true]:border-border data-[scrolled=true]:bg-card/85 data-[scrolled=true]:backdrop-blur-xl "
            : "") +
